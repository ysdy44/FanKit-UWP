...
namespace FanKit.Win2Ds
{
    public class HomographyController
    {
        ...
        public struct Transformer
        {
            ...
            /// draw a ロ
            /// </summary>
            private void DrawNodeVector3(CanvasDrawingSession ds, Vector2 vector)
            {
            ...
            /// draw a ロ
            /// </summary>
            private void DrawNodeVector4(CanvasDrawingSession ds, Vector2 vector)
            {
                ds.FillRectangle(vector.X - 7, vector.Y - 7, 14, 14, Windows.UI.Color.FromArgb(70, 127, 127, 127));
        ...
        public class NoneController : IController
        {
            ...
            public void Delta(Vector2 point, Layer layer, Matrix3x2 matrix, Matrix3x2 inverseMatrix) { }
            public void Complete(Vector2 point, Layer layer, Matrix3x2 matrix, Matrix3x2 inverseMatrix) => layer.ResetTransformer();
        }
