...
namespace FanKit.Frames.Win2Ds
{
    public sealed partial class HomographyControllerPage : Page
    {
        ...
        public HomographyControllerPage()
        {
            ...
            {
                this.MarkdownText1.Text = await FanKit.Samples.File.GetFile("ms-appx:///TXT/Win2Ds/HomographyControllerPage.xaml.txt");
                this.MarkdownText2.Text = await FanKit.Samples.File.GetFile("ms-appx:///TXT/Win2Ds/HomographyControllerPage.xaml.cs.txt");
                this.MarkdownText3.Text = await FanKit.Samples.File.GetFile("ms-appx:///TXT/Win2Ds/HomographyController.cs.txt");
            };
