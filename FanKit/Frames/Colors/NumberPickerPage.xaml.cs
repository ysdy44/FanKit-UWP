...
namespace FanKit.Frames.Colors
{
    public sealed partial class NumberPickerPage : Page
    {
        ...
        {
            this.MarkdownText1.Text = await FanKit.Library.File.GetFile("ms-appx:///TXT/Colors/NumberPickerXaml.txt");
            this.MarkdownText2.Text = await FanKit.Library.File.GetFile("ms-appx:///TXT/Colors/NumberPickerUserXaml.txt");
            this.MarkdownText3.Text = await FanKit.Library.File.GetFile("ms-appx:///TXT/Colors/NumberPickerUserCs.txt");
        }
