...
namespace FanKit.Frames.Template
{
    public sealed partial class SplitPanelPage : Page
    {
        ...
        private async void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            this.MarkdownText3.Text = await FanKit.Sample.File.GetFile("ms-appx:///TXT/Template/SplitButton.xaml.txt");
            this.MarkdownText4.Text = await FanKit.Sample.File.GetFile("ms-appx:///TXT/Template/SplitButton.cs.txt");
        }
